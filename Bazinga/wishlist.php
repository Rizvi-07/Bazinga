...
<link rel="stylesheet" href="wishlist2.css">
...
<body>
		...
		<div class="drp">
		   <section>
		        <p id="hd1" style="text-align:center;"> My Wishlist </p>
		   </section>
		            <aside>
		...
		$sql="SELECT wishlist.movie_id,Thumbnil,MovieName,Rating,Category FROM movies Inner Join wishlist ON movies.movie_id=wishlist.movie_id WHERE wishlist.UserId='".$x."' ORDER BY ".$selectOption." desc";
		...
		<?php
							      ...
							      if(isset($_POST['wish']) && $_POST['wish'] != "")
                             {
                               ...
                               $sql = "DELETE FROM wishlist where UserId='".$x."' and movie_id=".$y;
